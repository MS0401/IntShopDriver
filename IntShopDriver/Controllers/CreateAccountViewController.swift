...
//  IntShopDriver
//
//  Created by Olexandr on 10/25/17.
...
class CreateAccountViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func Initialize() {
        ...
        //MARK: check box customize.
        // Customized checkbox
        self.checkBox.line = .thin
        self.checkBox.bgColorSelected = UIColor.init(netHex: 0x3493D5)
        self.checkBox.bgColor = UIColor.init(netHex: 0x3493D5)
        self.checkBox.color = UIColor.white
        self.checkBox.borderColor = UIColor.init(netHex: 0x3493D5)
        self.checkBox.borderWidth = 3
...
//        let cancel = self.storyboard?.instantiateViewController(withIdentifier: "login") as! ViewController
...
//        self.navigationController?.popToViewController(vc!, animated: true)
        ...
        self.delegate?.SuccessfullyCreated(controller: self, didsuccessful: success!)
        
        SharingManager.sharedInstance.create = true
        self.dismiss(animated: true, completion: nil)
    }
    ...
    func pickUpValue(textField: UITextField) {
        ...
        picker.backgroundColor = UIColor(netHex: 0x2484C6)
...
extension CreateAccountViewController: SCDateFieldDelegate {
...
extension CreateAccountViewController: PagedFlowViewDelegate, PagedFlowViewDataSource {
...
extension CreateAccountViewController: CountrySelectedDelegate {
...
extension CreateAccountViewController:  CLLocationManagerDelegate {
